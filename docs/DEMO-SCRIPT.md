...
## 1. One command brings the whole stack up (2 min)
...
- the ranked high-risk part (**Mobile launcher umbilical**, risk 99, ~35-day avg slip)
  and **its supplier** (resolved via a second governed call: PurchaseOrder → Vendor);
